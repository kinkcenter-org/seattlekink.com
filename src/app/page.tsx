...
export default function Home() {
  return (
    <main className="flex flex-col grow place-content-center gap-8 row-start-2 items-center place-items-center text-center max-w-[600]">
      ...
      <div className="flex gap-4 items-center flex-col sm:flex-row">
        ...
        <LinkButton href="/groups">Groups</LinkButton>
